...
import { Page, BrowserContext } from "./page";
import { z } from "zod";
...
export interface ConstructorParams {
  ...
  /**
   * Instructions for navengine.
   */
  systemPrompt?: string;
}

export interface InitOptions {
  /** @deprecated Pass this into the NavEngine constructor instead. This will be removed in the next major version. */
  modelName?: AvailableModel;
  /** @deprecated Pass this into the NavEngine constructor instead. This will be removed in the next major version. */
  modelClientOptions?: ClientOptions;
  /** @deprecated Pass this into the NavEngine constructor instead. This will be removed in the next major version. */
...
export interface ActOptions {
  ...
  modelName?: AvailableModel;
  modelClientOptions?: ClientOptions;
  /** @deprecated Vision is not supported in this version of NavEngine. */
  useVision?: boolean;
